                                        ...
                                        <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="kt_modal_add_user_form" class="form" action="{{route('companies.store')}}" method="POST">
                                                            @csrf
                                                            <!--begin::Scroll-->
                                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <input type="text" name="name"
                                                                           ...
                                                                           placeholder="Full name" value="Muhanned"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <input type="email" name="email"
                                                                           ...
                                                                           value="devmuhannedanwar@gmail.com"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
...
<script src="admin-panel/plugins/global/plugins.bundle.js"></script>
<script src="admin-panel/js/scripts.bundle.js"></script>
<!--end::Global Javascript Bundle-->
<!--begin::Vendors Javascript(used for this page only)-->
<script src="admin-panel/plugins/custom/datatables/datatables.bundle.js"></script>
<!--end::Vendors Javascript-->
<!--begin::Custom Javascript(used for this page only)-->
<script src="admin-panel/js/custom/apps/user-management/users/list/table.js"></script>
<script src="admin-panel/js/custom/apps/user-management/users/list/export-users.js"></script>
<script src="admin-panel/js/custom/apps/user-management/users/list/add.js"></script>
<script src="admin-panel/js/widgets.bundle.js"></script>
<script src="admin-panel/js/custom/apps/chat/chat.js"></script>
<script src="admin-panel/js/custom/utilities/modals/upgrade-plan.js"></script>
<script src="admin-panel/js/custom/utilities/modals/create-campaign.js"></script>
<script src="admin-panel/js/custom/utilities/modals/users-search.js"></script>
